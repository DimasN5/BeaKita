...
class _SearchPageState extends State<SearchPage> {
  ...
  void initState() {
    super.initState();
    filteredList = scholarshipList;
  }

  void searchScholarship(String keyword) {
    filterScholarship(keyword, currentFilter);
  }
  ...
  void filterScholarship(
    ...
    setState(() {
      ...
      filteredList = scholarshipList.where((item) {
        final matchKeyword =
            keyword.isEmpty ||
                item.title.toLowerCase().contains(keyword.toLowerCase()) ||
                item.organization.toLowerCase().contains(keyword.toLowerCase());

        final matchCategory = filter.category == "All"
            ? true
            : item.category == filter.category;

        final matchFunding = filter.funding == "All"
            ? true
            : item.funding == filter.funding;

        final matchLocation = filter.location == "All"
            ? true
          ...
          children: [
            ...
            Align(
              ...
              child: Text(
                ...
                "${filteredList.length} Scholarship Found",
            ...
            children: [
              ...
              Wrap(
                ...
                children: [
                  ...
                  buildChip("All", category),
                  buildChip("S1", category),
                  buildChip("S2", category),
                  buildChip("S2/S3", category),
              ...
              Wrap(
                ...
                children: [
                  ...
                  buildFundingChip("All"),
                  buildFundingChip("Fully Funded"),
                  buildFundingChip("Partial"),
              ...
              Wrap(
                ...
                children: [
                  ...
                  buildLocationChip("All"),
                  buildLocationChip("Indonesia"),
                  buildLocationChip("Indonesia & Overseas"),
